...
def render_manual_inputs_locked(mi: dict):
    st.markdown(
        '<div class="card"><h3>Big Picture Market Pulse Dashboard</h3></div>',
        unsafe_allow_html=True,
    )
    ...
    with c1:
        ...
        st.markdown(
            '<div class="card"><h3>Trend Condition (QQQ)</h3><div class="hint">Simple yes/no filters.</div>',
            unsafe_allow_html=True,
        )
    ...
    with c2:
        st.markdown(
            '<div class="card"><h3>Nasdaq Net 52-Week New High/Low</h3><div class="hint">Positive = green, negative = red.</div>',
            unsafe_allow_html=True,
        )
        ...
        st.markdown(
            '<div class="card"><h3>Market Indicators</h3><div class="hint">Your tape / sentiment inputs.</div>',
            unsafe_allow_html=True,
        )
    ...
    with c3:
        ...
        st.markdown(
            '<div class="card"><h3>Breadth & Participation</h3><div class="hint">Percent of names above key moving averages.</div>',
            unsafe_allow_html=True,
        )
        ...
        st.markdown(
            '<div class="card"><h3>Composite Model</h3><div class="hint">0.0–2.0 each • Total out of 10.</div>',
            unsafe_allow_html=True,
        )
